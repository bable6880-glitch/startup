...
export default function TiffinServiceIslamabadPage() {
    ...
    return (
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <JsonLd schema={buildFAQSchema(ISLAMABAD_FAQ.map(f => ({ question: f.q, answer: f.a })))} />
            <JsonLd schema={buildBreadcrumbSchema([
                { name: 'Home', url: BASE_URL },
                { name: 'Islamabad', url: `${BASE_URL}/city/islamabad` },
                { name: 'Tiffin Service Islamabad', url: `${BASE_URL}/tiffin-service-islamabad` }
            ])} />

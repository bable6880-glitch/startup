                ...
                <div className="w-full max-w-md animate-slide-up">
                    ...
                    <div className="rounded-3xl border border-neutral-200/70 bg-white/80 backdrop-blur-xl p-8 shadow-xl shadow-neutral-200/40 dark:bg-neutral-800/80 dark:border-neutral-700 dark:shadow-neutral-900/40">
                        ...
                        <div className="relative">
                            <button
                                disabled
                                className="w-full flex items-center justify-center gap-3 rounded-2xl bg-neutral-50 border-2 border-neutral-100 px-5 py-4 text-sm font-semibold text-neutral-300 transition-all cursor-not-allowed select-none dark:bg-neutral-800/50 dark:border-neutral-700/50 dark:text-neutral-500"
                            >
                                <svg className="h-5 w-5 fill-neutral-300 dark:fill-neutral-500" viewBox="0 0 24 24">
                            ...
                            <span className="absolute -top-2 -right-2 bg-orange-400 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm pointer-events-none">
                                SOON
                            </span>
                        </div>
